...
public class VaccinationFromDataTest {
	...
	private VaccinationFromRkiData model;
	...
	public void setUp() throws Exception {
		...
		VaccinationFromRkiData.Config conf = VaccinationFromRkiData.newConfig("05315")
				.withAgeGroup("12-17", 54587.2)
				.withAgeGroup("18-59", 676995)
				.withAgeGroup("60+", 250986);

		model = new VaccinationFromRkiData(rnd, config, conf);
