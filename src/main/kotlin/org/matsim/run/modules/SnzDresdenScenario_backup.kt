 ...
 */
class SnzDresdenScenario_backup  // public static final Path INPUT = Path.of("/home/abhishek/Desktop/episim-dresden-libs/dresden-data");
/**
 ...
 */
    ...
    fun config(): Config {
        ...
        ConfigUtils.addOrGetModule(config, VirusStrainConfigGroup::class.java)
                .getOrAddParams(VirusStrain.OMICRON).infectiousness = 3.0
